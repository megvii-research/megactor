from libs.controlnet_resource.dense_aux.densepredictor import DensePosePredictor
from libs.controlnet_aux_lib import DWposeDetector, CannyDetector
import cv2
import numpy as np

class DenseDWposePredictor:
    def __init__(self, device, resolution = [512, 512]) -> None:
        det_config = './libs/controlnet_resource/controlnet_aux/src/controlnet_aux/dwpose/yolox_config/yolox_l_8xb8-300e_coco.py'
        det_ckpt = '/data/code/yangshurong/cache/magic_pretrain/control_aux/yolox_l_8x8_300e_coco_20211126_140236-d3bd2b23.pth'
        pose_config = './libs/controlnet_resource/controlnet_aux/src/controlnet_aux/dwpose/dwpose_config/dwpose-l_384x288.py'
        pose_ckpt = '/data/code/yangshurong/cache/magic_pretrain/control_aux/dw-ll_ucoco_384.pth'
        dense_weight_path = "/data/code/yangshurong/cache/magic_pretrain/control_aux/densepose_model.pkl"
    ...
    def __call__(self, img):
        ...
        # canny_frame = self.canny_detector(img)
        ...
        dense_frame *= dense_res_face[:, :, None] # only save dense on face
