...
class UNet3DConditionModel(ModelMixin, ConfigMixin):
    ...
    @classmethod
    def from_pretrained_2d(cls, pretrained_model_path, subfolder=None, unet_train_dict_path="", unet_additional_kwargs=None):
        ...
        if unet_train_dict_path != "":
            print(f"for training load unet_train_dict from {unet_train_dict_path}")
            motion_module_state_dict = torch.load(unet_train_dict_path, map_location="cpu")
            motion_module_state_dict = motion_module_state_dict["state_dict"] if "state_dict" in motion_module_state_dict else motion_module_state_dict
            state_dict.update({name.replace('module.', ''): param for name, param in motion_module_state_dict.items()})
