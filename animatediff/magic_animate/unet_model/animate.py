...
from animatediff.magic_animate.sparse_control.sparse_controlnet import SparseControlNetModel
    ...
    def __init__(self,
        ...
        *_, func_args = inspect.getargvalues(inspect.currentframe())
        ...
        if controlnet_type == '2d':
            ...
            from animatediff.magic_animate.sparse_control.pipeline import AnimationPipeline as TrainPipeline
