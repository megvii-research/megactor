...
class DiTControlNetModel(ModelMixin, ConfigMixin):
    ...
    def from_dit(
        ...
        if load_weights_from_unet:
            ...
            controlnet.transformer_blocks.load_state_dict(dit_model.transformer_blocks[12:-1].state_dict())
    ...
    def forward(
        ...
        controlnet_results = []
        for i in range(12):
            hidden_states = unet.transformer_blocks[i](
                hidden_states,
